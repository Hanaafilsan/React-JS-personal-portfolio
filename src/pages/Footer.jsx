  ...
  return (
    <footer className="footer--container" id="footer">
      <div className="footer--link--container">
        <div>
        <img src="./img/logo.png" alt="Logo"  width="200" height="70"/>
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=100085940062496&mibextid=ZbWKwL/"
            ...
            <li>
              <a
                href="https://www.instagram.com/hani_bocor51?igsh=N2JsbTJqNno5Zjkw/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/hani-nuur-bocor-8762b42a5/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made by Hani Bocor💓 </p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
